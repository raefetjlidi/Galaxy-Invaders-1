					...
					<div class="col-md-12 col-lg-7 offset-lg-1 offset-xl-0">
						<div class="hero-text">
							<div class="hero-text-tablecell">
								<p class="subtitle"></p>
								<h1>Best Astronomy Equipments</h1>
								<div class="hero-btns">
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-10 offset-lg-1 text-center">
						<div class="hero-text">
							<div class="hero-text-tablecell">
								<p class="subtitle">New products Everyday</p>
								<h1>100% Best Collection</h1>
								<div class="hero-btns">
									<a href="shop.php" class="boxed-btn">Visit Shop</a>
									<a href="contact.php" class="bordered-btn">Contact Us</a>
								</div>
			...
			<div class="row">
				<div class="col-lg-4 col-md-6 text-center">
					<div class="single-product-item">
						...
						<h3>Nexstar 6 SE télescope Celestron</h3>
						<p class="product-price"><span></span> 1000 DT </p>
				...
				<div class="col-lg-4 col-md-6 text-center">
					<div class="single-product-item">
						...
						<h3>Skywatcher 200/1000 NEQ-5</h3>
						<p class="product-price"><span></span> 649,00 DT </p>
						<a href="cart.php" class="cart-btn"><i class="fas fa-shopping-cart"></i> Add to Cart</a>
					</div>
				</div>
				<div class="col-lg-4 col-md-6 offset-md-3 offset-lg-0 text-center">
					<div class="single-product-item">
						...
						<h3>Lunette Celestron AstroMaster 90/1000 EQ motorisée
						</h3>
						<p class="product-price"><span></span> 326,00 DT </p>
						<a href="cart.php" class="cart-btn"><i class="fas fa-shopping-cart"></i> Add to Cart</a>
					</div>
				</div>
			</div>
    	...
    	<div class="container">
        	<div class="row clearfix">
                ...
                <div class="content-column col-lg-6">
                    ...
                    <h4>Télescope CPC SC 1100 Fastar Schmidt-Cassegrain Celestron
					</h4>
					...
					<div class="testimonial-sliders">
						<div class="single-testimonial-slider">
							...
							<div class="client-meta">
								<h3>Saira Hakim <span>Galaxy Invaders Client</span></h3>
						...
						<div class="single-testimonial-slider">
							...
							<div class="client-meta">
								<h3>David Niph <span>Galaxy Invaders Client</span></h3>
								<p class="testimonial-body">
									" Sed ut perspiciatis unde omnis iste natus error veritatis et  quasi architecto beatae vitae dict eaque ipsa quae ab illo inventore Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium "
								</p>
								<div class="last-icon">
						...
						<div class="single-testimonial-slider">
							...
							<div class="client-meta">
								<h3>Jacob Sikim <span>Galaxy Invaders Client</span></h3>
								<p class="testimonial-body">
									" Sed ut perspiciatis unde omnis iste natus error veritatis et  quasi architecto beatae vitae dict eaque ipsa quae ab illo inventore Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium "
								</p>
								<div class="last-icon">
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-6 col-md-12">
					<div class="abt-bg">
						<a href="https://www.youtube.com/watch?v=Z3xkHmC-KQE" class="video-play-btn popup-youtube"><i class="fas fa-play"></i></a>
					</div>
				</div>
				<div class="col-lg-6 col-md-12">
					<div class="abt-text">
						<p class="top-sub">Since Year 2021</p>
						<h2>We are <span class="orange-text">Galaxy Invaders</span></h2>
	...
	<div class="latest-news pt-150 pb-150">
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-8 offset-lg-2 text-center">
					<div class="section-title">	
						<h3><span class="orange-text">Our</span> Articles</h3>
						<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquid, fuga quas itaque eveniet beatae optio.</p>
					</div>
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-lg-4 col-md-6 offset-md-3 offset-lg-0">
					<div class="single-latest-news">
						...
						<div class="news-text-box">
							<h3><a href="phpsingle-news.php">What is astronomy.</a></h3>
							<p class="blog-meta">
								<span class="author"><i class="fas fa-user"></i> Admin</span>
